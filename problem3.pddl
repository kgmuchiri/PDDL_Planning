(define (problem mission3)
    ...
    (:goal
        (and
            ;construct a generator in shallow location 1 and shallow location 2
            ;install off-shore cable in deep-water1
            ;construct research base at deep-water 1
            ;analyse deep-water 1
            (has-generator shallow1)
            (has-generator shallow2)
